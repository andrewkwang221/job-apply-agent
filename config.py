...
MAX_JOB_AGE_DAYS = 3  # Incremental fetch window after a source has been ingested
MAX_JOB_AGE_DAYS_INITIAL = 30  # First completed fetch for a source (jobs_fetched > 0)
